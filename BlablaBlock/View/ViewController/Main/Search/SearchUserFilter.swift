...
public enum SearchUserFilter: String {
    ...
    static func filter(_ index: Int) -> SearchUserFilter {
        return SearchUserFilter(rawValue: SearchUserFilter.typeList[index])!
    }
}
